...
export default function NewSessionCard({ onStart, microphoneLabel, languageLabel, onOpenSettings, onImport, onImportAudio, onImportConversation, onPasteConversation }) {
    ...
    <div className={styles.card}>
      <div className={styles.content}>
        ...
        <div className={styles.importRow}>
          ...
          <div className={styles.importDropdown} ref={importMenuRef}>
            <button
              className={styles.importButton}
              onClick={() => setShowImportMenu(v => !v)}
              data-tooltip={t('newSessionCard.importConversationDescription')}
            >
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" style={{ marginLeft: 2 }}>
            ...
            {showImportMenu && (
              <div className={styles.importMenu}>
                <button
                  ...
                  onClick={() => { setShowImportMenu(false); onImportConversation(); }}
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    <polyline points="14 2 14 8 20 8"/>
                  </svg>
                  {t('newSessionCard.uploadFile')}
                </button>
                <button
                  className={styles.importMenuItem}
                  onClick={() => { setShowImportMenu(false); onPasteConversation?.(); }}
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="9" y="9" width="13" height="13" rx="2" ry="2"/>
                    <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/>
                  </svg>
                  {t('newSessionCard.pasteConversation')}
                </button>
              </div>
            )}
          </div>
