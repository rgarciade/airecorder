    ...
    <div className={styles.card}>
      <div className={styles.content}>
        ...
        <div className={styles.importRow}>
          <button className={styles.importButton} onClick={onImport} title={t('newSessionCard.teams')}>
          ...
          <button className={styles.importButton} onClick={onImportAudio} title={t('newSessionCard.audio')}>
