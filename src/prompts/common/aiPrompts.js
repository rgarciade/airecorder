// Prompts comunes de la aplicación (sin dependencia de experto)
// Este archivo es el canónico; los expertos extienden su comportamiento
// inyectando su propio prompt de especialidad ANTES de estos.
...
/**
 * System prompt fijo para mejorar una tarea individual.
 * @param {string} lang - Código de idioma ('es', 'en', ...)
 */
...
/**
 * System prompt para análisis completo de proyecto.
 * @param {string} lang - Código de idioma ('es', 'en', ...)
 */
