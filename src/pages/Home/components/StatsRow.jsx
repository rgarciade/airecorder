    ...
    <div className={styles.row}>
      <div className={styles.card}>
        ...
        <div className={styles.info}>
          <span className={styles.label}>{t('statsRow.thisWeek')}</span>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.info}>
          <span className={styles.label}>{t('statsRow.transcriptions')}</span>
          <span className={styles.value}>{totalFiles} {t('statsRow.files')}</span>
        </div>
      </div>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.info}>
          <span className={styles.label}>{t('statsRow.totalRecorded')}</span>
